...
9. [Файл README](#файл-readme)
10. [Zsh: Основные команды](#zsh-основные-команды)
    - [Навигация](#навигация)
    - [Создание и Управление Файлами](#создание-и-управление-файлами)
    - [Копирование и Перемещение](#копирование-и-перемещение)
    - [Чтение и Работа с Содержимым](#чтение-и-работа-с-содержимым)
    - [Удаление](#удаление)
    - [Информация о Командах](#информация-о-командах)
    - [Настройки и Конфигурация](#настройки-и-конфигурация)
    11. [Zsh: Hot-keys](#zsh-hot-keys)
---
# Git команды
...
# Файл README
При работе с файлом `README` в `Git`, хорошей практикой является краткое и точное описание действий в сообщении коммита. Примеры, как можно красиво и понятно подписывать коммиты:
- `feat(README): Добавлен новый раздел 'Название раздела'`
- `style(README): Форматирование для улучшения читаемости`
- `fix(README): Коррекция текста. Исправлены опечатки`
- `refactor(README): Удален устаревший раздел 'Название раздела'`
- `update(README): Добавлена информация в 'Название раздела'`
...
- `cd <directory>` — перейти в указанную папку (например, `cd first-project` или `cd ..`).

## Создание и Управление Файлами
- `touch <file>` — создание файла.
- `mkdir <directory>` — создание папки.
- `take <directory>` — создание новой директории и сразу же переход в нее.

## Копирование и Перемещение
- `cp <source> <destination>` — скопировать файл или папку (например, `cp file.txt ~/my-dir`).
- `mv <source> <destination>` — переместить файл или папку.

## Чтение и Работа с Содержимым
- `cat <file>` — показать содержимое файла (например, `cat file.txt`).

## Удаление
- `rm <file>` — удалить файл (например, `rm about.html`).
- `rmdir <directory>` — удалить папку (например, `rmdir images`).
- `rm -r <directory>` — удалить папку и всё, что она содержит (например, `rm -r second-project`).

## Информация о Командах
- `man <command>` — показать подробную информацию о команде.
- `type <команда>` — определить тип команды (встроенная, внешняя и т.д.).
- `history` — показать историю введенных команд.

## Настройки и Конфигурация
- `alias <алиас>='команда'` — создание псевдонима для команды.
- `unalias <алиас>` — удаление псевдонима.
- `chmod <код доступа> <директория/файл>` — изменить права доступа.
- `grep <word> <dir/file>` — поиск слова в файле или папке.
- `cat <file> > <source>` — перенаправление потока вывода.
- `tree` — отобразить структуру директорий и файлов в виде дерева.

# Zsh: Hot-keys
- `Ctrl + a` — переход в начало строки.
- `Ctrl + e` — переход к концу строки.
- `Ctrl + u` — удалить все символы до начала строки (перед курсором).
- `Ctrl + k` — удалить все символы до конца строки (после курсора).
- `Ctrl + l` — очистить экран. Аналог команды `clear`.
- `Ctrl + c` — завершить процесс, выполняющийся в терминале.
